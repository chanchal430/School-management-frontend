...
import { postalDispatchStats, postalDispatchData } from "../../../mock/frontOfficeData";
import {
  Send,
  FileText,
  CheckCircle,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <StatCard
          ...
          value={postalDispatchStats.totalDispatches}
          icon={<Send size={20} />}
          color="indigo"
        />
        <StatCard
          title="Pending Delivery"
          value={postalDispatchStats.pendingDelivery}
          icon={<FileText size={20} />}
          color="amber"
        />
        <StatCard
          title="Delivered successfully"
          value={postalDispatchStats.deliveredSuccessfully}
